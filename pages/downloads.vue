<template>
  <div>
    ...
    <p class="text-lg p-2 pl-10">The following downloads are hosted on GitHub, you can also find them on the 
    <a href="https://github.com/Raspirus/Raspirus/releases" target="_blank" class="text-mainred-500">GitHub Releases Page</a>.
...
const data = githubData.value;
var formattedDate: string = "0";
